...
$h(y)=\left\{\begin{array}{cc} x,\mbox{ where }f(x)=y & \forall y\in
f_*(A)\\ a & \forall y\in B-f_*(A)\end{array}\right\}$.  Since $f$ is
...
$$g(x)=\left\{\begin{array}{cc} 1_A(x) & \forall x\in
A-\{x_1,x_2\}\\ x_2 & x=x_1\\
x_1 & x=x_2\end{array}\right\}.$$ Thus $h\not= g$, yet $f\circ h=f=f\circ
