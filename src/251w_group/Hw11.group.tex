...
\begin{document}
	...
	\begin{problem}[manual-num=57]
		...
		\begin{proof}
			We ask whether $X$ for all natural numbers $n$.
			We will show this to be true through induction.
			...
			Let $k$ be an arbitrary natural number so that $k \geq 6$ and $7n < 2^n$ for $n = k$.
			Take the case where $n = k + 1$.
	...
	\begin{problem}[manual-num=61]
		\begin{proposition}
			Prove that for all sets $A$ and $B$ and functions $f : A \rightarrow B$, $f \pimg (\bigcup_{i=1}^{n} W_i) =\bigcup_{i=1}^{n} f \pimg (W_i)$ for all natural numbers $n$, where $W_i \subseteq B$ for all $i \leq n$.
		\end{proposition}
		...
		\begin{proof}
			...
			Let $W$ be a family of sets indexed by $i$ so that $W_i \subseteq B$ for all $i \leq n$.
			...
			Therefore, for all sets $A$ and $B$ and functions $f : A \rightarrow B$, $f \pimg (\bigcup_{i=1}^{n} W_i) =\bigcup_{i=1}^{n} f \pimg (W_i)$ for all natural numbers $n$, where $W_i \subseteq B$ for all $i \leq n$.
		\end{proof}
	\end{problem}
	...
	\begin{problem}[manual-num=62]
		...
		\begin{proof}
			...
			$\sum_{i = 1}^{1} F_i = F_1 = 1 = 2 - 1 = F_{n + 2} - 1$.
			By substitution, we see that $\sum_{i = 1}^{n} F_i = F_{n + 2} - 1$ for $n = 1$.

			Let $k$ be an arbitrary natural number so that $\sum_{i = 1}^{n} F_i = F_{n + 2} - 1$ for $n = k$.
			Take the case where $n = k + 1$.
		...
		\begin{proof}
			...
			Let $k$ be an arbitrary natural number so that $\sum_{i = 1}^{n} F_i^2 = F_n \cdot F_{n + 1}$ for $n = k$.
			Take the case where $n = k + 1$.
