	...
	\begin{problem}[manual-num=56]
		...
		\begin{enumerate}
			...
			\begin{proof}
				...
				By substitution, we see that $a \in P_a$.
				...
				By substitution, we see that $b_0 \in Q_b$.
				By the definition of subsets, since $b_0 \in P_b$ implies $b_0 \in Q_b$, we see that $P_b \subseteq Q_b$.
				Analogously, exchanging $P_b$ for $Q_b$ and $b_p$ for $b_q$, we see that $Q_b \subseteq P_b$.
				...
				Let $c_2$ be an arbitrary element of $A$.
				By the definition of set quotients, we see that there exists a particular element $Q_c \in A / \sim$ so that $Q_c = \sim [c_2]$.
				By the definition of reflexive relations, we see that $c_2 \in \sim [c_2]$.
				By substitution, we see that $c_2 \in Q_c$.
				By the definition of indexed union, since there exists a particular element $Q_c \in A / \sim$ so that $c_2 \in Q_c$, we see that $c_2 \in \bigcup_{P \in A / \sim} P$.
				By the definition of subsets, since $c_2 \in A$ implies $c_2 \in \bigcup_{P \in A / \sim} P$, we see that $A \subseteq \bigcup_{P \in A / \sim} P$.
				...
				By substitution, since $A / \sim = F(\sim)$, we see that $F(\sim)$ is a partition.
				By the definition of $\T_A$, we see that $F(\sim) \in \T_A$.
			...
			\begin{proof}
				...
				We ask whether $R_\W$ is an equivalence relation.
				...
				By the definition of $R_\W$, we see that there exists a element $P_c \in \W$ so that $c_0 \in P_c$ and so that $c_1 \in P_c$.
				By the definition of $R_\W$, we see that there exists a element $Q_c \in \W$ so that $c_1 \in Q_c$ and so that $c_2 \in Q_c$.
			...
			\begin{proof}
				...
				Let $a_0$ be an arbitrary element of $A$.
				By the definition of quotient sets, we see that $R_\W [a_0]$ is an arbitrary element in $A / R_\W$.
				By the definition of reflexive relations, we see that $a_0 \in R_\W [a_0]$.
				By the definition of partitions, since $\W$ is exhaustive, we see that there exists a particular element $P_a \in \W$ so that $a_0 \in P_a$.
				Let $a_1$ be an arbitrary element of $R_\W [a_0]$.
				By the definition of equivalence classes, we see that $(a_0, a_1) \in R_\W$.
				By the definition of $R_\W$, we see that there exists an element $Q_a \in \W$ so that $a_0 \in Q_a$ and $a_1 \in Q_a$.
				By the definition of pairwise disjoint sets, since $a_0 \in P_a$, we see that $P_a = Q_a$.
				By substitution, we see that $a_1 \in P_a$.
				By the definition of subsets, since $a_1 \in R_\W [a_0]$ implies $a_1 \in P_a$, we see that $R_\W [a_0] \subseteq P_a$.
				Let $a_p$ be an arbitrary element of $P_a$.
				By the definition of $R_\W$, since $a_0 \in P_a$, we see that $(a_0, a_p) \in R_\W$.
				By the definition of the equivalence class, we see that $a_p \in R_\W [a_0]$.
				By the definition of subsets, since $a_p \in P_a$ implies $a_p \in R_\W [a_0]$, we see that $P_a \subseteq R_\W [a_0]$.
				By the definition of set equality, we see that $R_\W [a_0] = P_a$.
				By substitution, we see that $R_\W [a_0] \in \W$.
				By the definition of subsets, since $R_\W [a_0] \in A / R_\W$ implies $R_\W [a_0] \in \W$, we see that $A / R_\W \subseteq \W$.

				Let $P_b$ be an arbitrary element of $\W$.
				By the definition of partitions, since $\W$ contains no empty subsets, there exists a particular element $b_0 \in P_b$.
				By the definition of $\W$, since $P_b \in \W$, we see that $b_0 \in A$.
				By the definition of quotient sets, we see that there exists a particular element $R_\W [b_0] \in A / R_\W$.
				Let $b_1$ be an arbitrary element of $R_\W [b_0]$.
				By the definition of equivalence classes, we see that $(b_0, b_1) \in R_\W$.
				By the definition of $R_\W$, we see that there exists an element $Q_b \in \W$ so that $b_0 \in Q_b$ and $b_1 \in Q_b$.
				By the definition of pairwise disjoint sets, since $b_0 \in P_b$, we see that $P_b = Q_b$.
				By substitution, we see that $b_1 \in P_b$.
				By the definition of subsets, since $b_1 \in R_\W [b_0]$ implies $b_1 \in P_b$, we see that $R_\W [b_0] \subseteq P_b$.
				Let $b_p$ be an arbitrary element of $P_b$.
				By the definition of $R_\W$, since $b_0 \in P_b$, we see that $(b_0, b_p) \in R_\W$.
				By the definition of the equivalence class, we see that $b_p \in R_\W [b_0]$.
				By the definition of subsets, since $b_p \in P_b$ implies $b_p \in R_\W [b_0]$, we see that $P_b \subseteq R_\W [b_0]$.
				By the definition of set equality, we see that $R_\W [b_0] = P_b$.
				By substitution, we see that $P_b = R_\W [b_0]$.
				By substitution, we see that $P_b \in A / R_\W$.
				By the definition of subsets, since $P_b \in \W$ implies $P_b \in A / R_\W$, we see that $\W \subseteq A / R_\W$.
			...
			\begin{proof}
				...
				By the definition of equivalence relations induced by partitions, there exists a particular element $P_b \in A / \sim$ so that $b_0 \in P_b$ and $b_1 \in P_b$.
				By the definition of set quotients, we see that there exists a particular element $b_2 \in A$ so that $P_b = \sim [b_2]$.
