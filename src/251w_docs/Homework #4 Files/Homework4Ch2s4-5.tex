...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
	...
	Given the proposition above,
	\begin{itemize}
		\item[a.] give a list of conditional statements you would prove to prove the entire stated equivalence.
		\medskip
		\item[b.] Prove \textbf{one} of those conditional statements from part a. Clearly state which proposition you are proving before the proof.
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
	...
	\underline{proposition:} For each real number $p$, there exist real numbers $q$ and $r$ such that $q\sin(r/5)=p.$
