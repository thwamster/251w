...
\begin{document}
	...
	\begin{enumerate}
		...
		\item $g(x)=x^2$, $h(x)=\left\{\begin{array}{cc}
										   x^3 & \mbox{ if
										   }x\ge 0\\ x^2 & \mbox{ if } x<0
		\end{array}\right.$
		\item $g(x)=\left\{\begin{array}{cc}
							   x^6 & \mbox{ if } x\ge0\\ x &
							   \mbox{ if } x<0
		\end{array}\right.$, $h(x)=\left\{\begin{array}{cc}
											  \sqrt{x}
											  & \mbox{ if } x\ge0\\ x & \mbox{ if } x<0
		\end{array}\right.$
	\end{enumerate}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
	...
	\begin{enumerate}
		\item $h(x)=\left\{\begin{array}{cc}
							   \frac{1}{5}
							   & \mbox{ if } x\ge0\\ -2 & \mbox{ if } x<0
		\end{array}\right.$,
		$k(x)=\left\{\begin{array}{cc}
						 10x & \mbox{ if } x\ge0\\
						 \frac{x}{-1} & \mbox{ if } x<0
		\end{array}\right.$
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
	...
	\begin{enumerate}
		...
		$$f_2(x)=\left\{\begin{array}{cc}
							ln(x) & \mbox{ if } x>0\\ x &
							\mbox{ if }x\le 0
		\end{array}\right.$$ for all $x\in \R$.
	\end{enumerate}
