...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
	...
	Let $f: A \rightarrow B$ be a function. We can define a new function $F: \mathcal{P}(A) \rightarrow \mathcal{P}(B)$ by the image map:
	\[ F(S) = f_{*}(S) = \{ f(x)  \mid x \in S \} \]

	\begin{enumerate}
		\item Prove that if $f$ is surjective, then $F$ is surjective.
		\item Is it true that if $f$ is injective, then $F$ is injective? Provide a proof or counterexample.
	\end{enumerate}
