...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
	...
	\begin{enumerate}
		\item[1] Given 3 arbitrary sets $A$, $B$, and $C,$ find an expression for $(A\cap B^C)\cup (B\cap C^C)$, using only union, intersection, and \emph{at most} one set difference. Prove the two expressions are equal.

		\item[2] Given a finite set $X$, with cardinality $|n|$ find $|\mathcal{P}(X\times X)\times\mathcal{P}(X\times X)|$ and $|\mathcal{P}(\mathcal{P}(X))|.$
	\end{enumerate}
